...
\begin{equation}
Y_{it} = \beta_{1}X_{it} + \sum_{i=1}^{T} \delta_{t}d_{t} + u_{it}
\end{equation}


Así combinando efectos fijos por tiempo y por individuo, tendríamos efectos fijos por dos lados (Two way fixed effects). 
