...
También notemos que la relevancia puede fallar si el instrumento es muy débil, lo cual sí puede ser testeable usando un F-test sobre los instrumentos en la first stage, solo tenemos que asegurarnos que $F$ es grande (tegla del meñique >10), también si el instrumeto es deil tendremos inconsistencia, y un sesgo incluso para muestras grandes y también afecta la normalidad, dificultando la inferencia 
